<? if($del_conf) { ?>
<div id="dbox">
	<p>Удалить новость &laquo;<?=$name?>&raquo;?</p>
	<form name="item" method="post" action="/admin/aedit/news">
...
<form name="settings" method="post">
	<? if ($reloc) { ?>
	<a href="/admin/aedit/news" class="left">Вернуться к новостям</a>
	<? } else { ?>
	...
	<table class="tablica1">
		...
		<tr>
			<td colspan=2 style="text-align: center;">
				...
				<? if (isset($artn)) { ?><a href="/admin/aedit/news/<?=$artn?>?delete" class="delete">Удалить</a><? } ?>
				<a href="/admin/aedit/news" class="left">Вернуться к новостям</a>
			</td>
		</tr>
	</table>
