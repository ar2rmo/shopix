...
<title><? if (is_null($page)) { ?>Новости<? if ($title) { ?> | <?=$title?><?}} else {?><?=$title?><?}?></title>
...
<div id="wrap">
	<div id="middle">
		<div id="container">
			...
			<? foreach ($arts as $art) { ?>
			<div id="article1">
				<a href="/news/<?=$art->uid ?>" class="article1"><?=$art->ht_caption ?></a>
				<div id="date-article1"><?=$art->ht_date ?></div>
				<div id="small-text1">
					<? if ($art->ispict) {?><div id="img-article"><a href="/news/<?=$art->uid ?>" title="<?=$art->nq_caption ?>"><img src="<?=$art->pict_uri?>" width="150" height="150"></a></div>
